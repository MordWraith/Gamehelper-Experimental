...
**Open-source fork maintained by** [MordWraith](https://github.com/MordWraith) — basis **Lafko / Gordin** ([GameHelper2](https://github.com/MordWraith/Gamehelper-Experimental)).
...
| **Stable channel** | Normal players | https://github.com/MordWraith/Gamehelper-Experimental |
...
```powershell
git clone https://github.com/MordWraith/Gamehelper-Experimental
...
- `GameOffsets` — offsets
- Plugins: `Atlas`, `AuraTracker`, `AutoPot`, `AutoHotKeyTrigger`, `HealthBars`, `SimpleBars`, `MapKillCounter`, `PreloadAlert`, `Radar`, `RitualHelper`, `RuneforgeHelper`, `RunecraftHelper`, `SekhemaHelper`, `PlayerBuffBar`, `AmanamuVoidAlert`, …
...
- [Upstream GameHelper2](https://github.com/MordWraith/Gamehelper-Experimental)
