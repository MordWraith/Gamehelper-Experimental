namespace RuneforgeHelper
{
    ...
    public sealed partial class RuneforgeHelperCore : PCore<RuneforgeHelperSettings>
    {
        ...
        public override void DrawSettings()
        {
            ...
            ImGui.Separator();
            ImGui.TextWrapped(this.L(
                "RuneforgeHelper draws stack-total prices (count × unit price) next to each visible reward in the in-game Runeshape Combinations panel. Use only ONE of RuneforgeHelper or RunecraftHelper — not both.",
                "RuneforgeHelper zeigt Gesamtpreise (Anzahl × Stueckpreis) neben jeder sichtbaren Belohnung im Runeshape-Combinations-Panel. Nur EINES von RuneforgeHelper oder RunecraftHelper nutzen — nicht beide."));
        }
