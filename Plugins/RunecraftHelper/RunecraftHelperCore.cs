namespace RunecraftHelper
{
    ...
    public sealed partial class RunecraftHelperCore : PCore<RunecraftHelperSettings>
    {
        ...
        {
            ImGui.TextWrapped("RunecraftHelper (yokkenUA upstream): while the in-game Runeshape Combinations panel is open, the " +
            ...
            ImGui.TextColored(new Vector4(1f, 0.85f, 0.2f, 1f),
                "Use only ONE of RunecraftHelper or RuneforgeHelper — not both (same overlays).");
