...
namespace GameHelper.RemoteObjects.States.InGameStateObjects
{
    ...
    public sealed class AtlasMapNode
    {
        ...
        /// <summary>
        ///     Gets the raw class-2 (badge) content ids ÔÇö the u32 at badge+0x188 of each
        ...
        //     and its high 16 bits encode the magnitude as (magnitude ├ù 64) ÔÇö i.e. magnitude = high16/64
        //     (1 for plain effects, the number in the text for "N additional"/"N% ÔÇª", 100 for binary
        ...
        /// <summary>
        ///     Known effect-token id (low 16 bits of a value in <see cref="ContentTokens" />) ÔåÆ effect-text
        ...
        /// <summary>
        ///     Known content id (low 16 bits of a value in <see cref="BadgeContentIds" />) ÔåÆ named-content
