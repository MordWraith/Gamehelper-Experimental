...
namespace GameHelper.RemoteObjects.States.InGameStateObjects
{
    ...
    public class ImportantUiElements : RemoteObjectBase
    {
        ...
        ///     (a left/right side panel, the passive skill tree, the world-travel map, or the endgame atlas).
        ...
        public bool IsEndgameAtlasPanelOpen =>
            this.Address != IntPtr.Zero && EndgameAtlasPanelDetector.IsOpen(this.Address);
        ...
        public bool ShouldHideWorldSpaceBars
        {
            get
            {
                if (this.IsInZoneMapUiActive)
                {
                    return this.WorldMapPanel.IsVisible && !this.IsInAreaTabLargeMapOpen;
                }
                ...
                return this.IsEndgameAtlasPanelOpen || this.IsCampaignWorldMapOpen;
            }
        }
        ...
        internal override void ToImGui()
        {
            ...
            ImGui.Text($"Tab Overlay (bars stay): {this.IsTabLargeMapOverlayActive}");
            ImGui.Text($"Hide World-Space Bars: {this.ShouldHideWorldSpaceBars}");
            ImGui.Text($"MiniMap Visible: {this.MiniMap.IsVisible}");
            ImGui.Text($"MiniMap flag: {UiElementVisibility.IsFlagVisible(this.MiniMap.Address)}");
            ...
            ImGui.Text($"WorldMapPanel flag: {UiElementVisibility.IsFlagVisible(this.WorldMapPanel.Address)}");
