namespace GameHelper.Ui
{
    ...
    internal static class ImGuiTheme
    {
        ...
        /// <summary>
        ///     Scrollable child for plugin settings inside tab items (explicit height + vertical scroll).
        /// </summary>
        internal static void BeginPluginSettingsPanel(string id)
        {
            ImGui.PushStyleColor(ImGuiCol.ChildBg, SectionBg);
            var avail = ImGui.GetContentRegionAvail();
            // Height 0 = fill remaining tab area; content scrolls inside the child.
            ImGui.BeginChild(id, new Vector2(avail.X, 0f), ImGuiChildFlags.Borders);
        }
